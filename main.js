...
{   'Aries':{
    ...
    'Taurus':{
        ...
        'Incompatibility': [{"Leo vs. Taurus": "You will find each other way too different to even tolerate each other, one is too rowdy while the other is too grounded"}, {"Aquarius vs. Taurus": "You will find each other way too different to even tolerate each other, one is too wistful while the other is too grounded"}, {"Sagittarius vs. Taurus": "You will find each other way too different to even tolerate each other, one is too rowdy while the other is too grounded"}]},
    'Gemini':{
        'dates': 
        ...
        'Incompatibility': [{"Capricorn vs. Gemini": "You will find each other way too different to even tolerate each other, one is too rowdy while the other is too grounded"}, {"Gemini vs. Taurus": "You will find each other way too different to even tolerate each other, one is too rowdy while the other is too grounded"}, {"Gemini vs. Scorpio": "You two find each other two-faced and stuck-up, it’s not gonna work"}]},
    'Cancer':{
        'dates':
