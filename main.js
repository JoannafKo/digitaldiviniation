...
{   'Aries':{
        ...
        'Flower': [{"Daffodil": "This flower is quite the dichotomy, symbolizing both new beginnings & death, fitting for an Aries"}, {"Daisy": "Your innocence * purity makes you adventurous, yet impulsive, just like the daisy itself"}, {"Sweet Pea": "A flower of good luck & farewells, as an Aries, you’ll need a sweet pea"}],
        'Compatibility':[{"Aries-Sagittarius": "You two have so much in common, you’re both adventurous & daring, & will protect one another"}, {"Aries-Gemini": "You two have so much in common, you’re both adventurous & daring, & will protect one another"}, {"Aries-Libra": "You two mutually respect one another’s differences & strengths, so you two will balance each other out"}]},
    'Taurus':{
        'dates':
        ...
        'Flower': [{"Daisy": "Just like the Daisy, the Taurus is fertile, secretive, & loving"}, {"Lily of the Valley": "This flower is associated with purity & humbleness, just like the Taurus"}, {"Hawthorn": "This flower is a very hopeful one, & can be very helpful to the health of the Taurus"}],
        'Compatibility':[{"Capricorn-Taurus": "You’re both gentle & reasonable, foundations for a good relationship"}, {"Taurus-Virgo": "A sense of justice & a sense of stability compliment each other very well"}, {"Cancer-Taurus": "You two are both caring & loving, & will protect each other no matter what"}],},
    'Gemini':{
        'dates': 
        ...
        'Flower': [{"Lily of the Valley": "This flower is associated with purity & the anticipation of warmth, just like the Gemini"}, {"Hawthorn": "This flower is a very hopeful one, & can be very helpful to the health of the Gemini"}, {"Honeysuckle": "This flower is the most attractive of them all, a magnet for everyone & everything"}],
    ...
    'Leo':{
        ...
        'Flower': [{"Gladiolus": "Just like the Leo, this flower symbolizes passion & infatuation"}, {"Poppy": "This flower has a flair of drama to it, like the Leo itself, being associated with remembrance & death"}, {"Water Lily": "This flower signifies balance & unity, a rather dangerous side to it however"}],
    ...
    'Virgo':{
        ...
        'Flower': [{"Aster": "A flower whose love is so powerful that is can ward off evil"}, {"Gladiolus": "Just like the Leo, this flower symbolizes stoicism & dignity"}, {"Poppy": "This flower has a flair of drama to it, like the Leo itself, being associated with remembrance & death"}],
        'Compatibility':[{"Capricorn-Virgo": "You’re both hard workers who prioritize getting the job done, good qualities for romance"}, {"Taurus-Virgo": "A sense of justice & a sense of stability compliment each other very well"}, {"Scorpio-Virgo": "A sense of justice & a sense of stability compliment each other very well"}]},
    'Libra':{
    ...
    'Scorpio':{
        ...
        'Gem' : [{"Beryl": "A stone thought to have healing powers"}, {"Opal": "A stone symbolizes hope & sex"}, {"Aquamarine": "A stone that maintains youth, virility, & transformation"}, {"Topaz": "A stone that celebrates union & marriage"}],
    ...
    'Sagittarius':{
        ...
        'Flower': [{"Chrysanthemum": "Wherever you go, this flower will signify differently, some places it will mean youth, while others it will mean friendship"}, {"Narcissus": "This flower & the Sagittarius are both full of self love & optimism"}, {"Holly": "This flower & the Sagittarius represent fertility & longevity"}],
        'Compatibility':[{"Sagittarius-Sagittarius": "You two have so much in common, you’re both adventurous & daring, & will protect one another"}, {"Gemini-Sagittarius": "Both of your spontaneity brings you closer together"}, {"Aries-Sagittarius": "You two have so much in common, you’re both adventurous & daring, & will protect one another"}]},
    'Capricorn':{
        ...
        'Flower': [{"Carnation": "A Capricorn would most certainly gravitate towards flowers that radiate maternal love & work ethic"}, {"Snowdrop": "This flower symbolizes hope in dark times, just like the Capricorn, empathetic like the Capricorn"}, {"Holly": "This flower & the Capricorn represent fertility & longevity"}],
        'Compatibility':[{"Capricorn-Virgo": "You’re both hard workers who prioritize getting the job done, good qualities for romance"}, {"Capricorn-Capricorn": "The fundamentals of a relationship rely on stability, so dating within your own sign can be preferable"}, {"Capricorn-Scorpio": "You both desire to be validated & perfected, which both of you can do for each other"}]},
    'Aquarius':{
        ...
        'Flower': [{"Snowdrop": "This flower symbolizes hope in dark times, just like the Capricorn, empathetic like the Aquarius"}, {"Violet": "This flower & the Aquarius are modest, humble, & dedicate devotion to loved ones"}, {"Primrose": "This flower is a gateway into the fantastical, so as an Aquarius should look out for any bizarre sightings"}],
    ...
    'Pisces':{
        ...
        'Gem' : [{"Amethyst": "A stone that symbolizes compassion & serenity"}, {"Zircon": "A stone that strengthens the wearer physically & mentally"}, {"Jasper": "A stimulant that induces relaxation & stamina"}, {"Aquamarine": "A stone that maintains youth, virility, & transformation"}],
        'Flower': [{"Violet": "This flower & the Aquarius are modest, humble, & dedicate devotion to loved ones"}, {"Primrose": "This flower is a gateway into the fantastical, so as an Aquarius should look out for any bizarre sightings"}, {"Jonquil": "Have no fear, for someone as intuitive as an Pisces, their love will be guaranteed to be reciprocated"}],
        'Compatibility':[{"Pisces-Scorpio": "Both of your intelligence & intuitivity will compliment each other very well"}, {"Capricorn-Pisces": "Both of your intelligence & intuitivity will compliment each other very well"}, {"Cancer-Pisces": "Both of your intelligence & intuitivity will compliment each other very well"}]}
};
...
function randomJob(){
    ...
    //pass the random numer to the object
    document.getElementById("Jobs").innerText = Object.keys(zodiac[myZodiac].Jobs[randomN])[0];
    document.getElementById("JobsDescription").innerText = Object.values(zodiac[myZodiac].Jobs[randomN])[0];
    console.log(randomN);   
}

function randomGem(){
    const randomN = Math.floor(Math.random()*4)
    document.getElementById("Gem").innerText = Object.keys(zodiac[myZodiac].Gem[randomN])[0];
    document.getElementById("GemDescription").innerText = Object.values(zodiac[myZodiac].Gem[randomN])[0];
}

function randomFlower(){
    const randomN = Math.floor(Math.random()*3)
    document.getElementById("Flower").innerText = Object.keys(zodiac[myZodiac].Flower[randomN])[0];
    document.getElementById("FlowerDescription").innerText = Object.values(zodiac[myZodiac].Flower[randomN])[0];
}

function randomCompatibility(){
    const randomN = Math.floor(Math.random()*3)
    document.getElementById("Compatibility").innerText = Object.keys(zodiac[myZodiac].Compatibility[randomN])[0];
    document.getElementById("CompatibilityDescription").innerText = Object.values(zodiac[myZodiac].Compatibility[randomN])[0];
}